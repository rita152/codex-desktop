...
export function ChatIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg aria-hidden="true" focusable="false" className={cn('icon', className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ForwardIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg aria-hidden="true" focusable="false" className={cn('icon', className)} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export function MenuIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg aria-hidden="true" focusable="false" className={cn('icon', className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      <path d="M4 6H20" />
      <path d="M4 12H20" />
      <path d="M4 18H20" />
    </svg>
...
export function SidebarLeftIcon({ size = 24, className = '' }: IconProps) {
  return (
    <svg aria-hidden="true" focusable="false" className={cn('icon', className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
